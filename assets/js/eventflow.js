(function ($) {
  ...
  // Portfolio masonry layout + filters
        ...
        $(sections).each(function () {
          if ($(this).offset().top <= windscroll + 100) {
            ...
            $(".one-page-scroll-menu")
              .find("li")
              .removeClass("current current-menu-ancestor current_page_item current-menu-parent");
            $(".one-page-scroll-menu")
  ...
  /*--------------------------------------------------------------
    Direct initializations (after DOM is ready)
  --------------------------------------------------------------*/
  ...
  // Clone main menu into mobile nav
  ...
  // Clone main menu into sticky header
  ...
  if ($(".main-menu__list li.dropdown").length) {
    $(".main-menu__list li.dropdown").each(function () {
      var $dropdown = $(this);
  ...
  /* Dropdown Menu Hover Fix (extra safety) */
  if ($(".main-menu__list li.dropdown").length) {
    $(".main-menu__list li.dropdown").each(function () {
      var $li = $(this),
        $sub = $li.children("ul");
  ...
  /*--------------------------------------------------------------
    Window load event (zonder .preloader fade)
  --------------------------------------------------------------*/
  $(window).on("load", function () {
    // Belangrijke init-functies
    thmSwiperInit();
    thmOwlInit();
    projectMasonaryLayout();
    fullHeight();

    // Isotope filter init (default)
    if ($(".post-filter").length) {
...
/*--------------------------------------------------------------
  Preloader (ALLEEN deze blijft)
--------------------------------------------------------------*/
(function ($) {
  "use strict";

  // 👉 Helemaal bovenaan binnen de IIFE:
  $("html").addClass("ss-preload");

  // ... al je functies: thmSwiperInit, thmOwlInit, etc. ...


  // 👉 Helemaal ONDERIN, maar nog steeds binnen (function($){ ... })(jQuery);
  $(window).on("load", function () {
    ...
    if ($(".post-filter.has-dynamic-filter-counter").length) {
      var activeFilterItem =
        $(".post-filter.has-dynamic-filter-counter").find("li");
